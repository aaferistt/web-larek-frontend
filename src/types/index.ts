...
export interface IProductCardViewConstructor extends IViewConstructor<IProductCardView> {}

export interface ICatalogView extends IView {
  setItems(products: IProduct[]): void;
}
export interface ICatalogViewConstructor extends IViewConstructor<ICatalogView> {}
...
export interface ICheckoutStep1ViewConstructor extends IViewConstructor<ICheckoutStep1View> {}

export interface ICheckoutStep2View extends IView {
  setState(state: OrderStateStep2): void;
}
export interface ICheckoutStep2ViewConstructor extends IViewConstructor<ICheckoutStep2View> {}
